-- ============================================
-- Complete Supabase Schema for Subscription Tracking App
-- ============================================
-- This schema includes:
-- 1. Subscriptions table with all required fields
-- 2. Banks table for payment method tracking
...
-- ============================================
-- 7. Create Function to Calculate Next Payment Date
-- ============================================
...
-- ============================================
-- 8. Create Trigger to Auto-Calculate Next Payment Date (Optional)
-- ============================================
-- Note: This is optional since the form can calculate it client-side
...
-- ============================================
COMMENT ON TABLE public.subscriptions IS 'Stores user subscription information for tracking and reminder notifications';
...
COMMENT ON COLUMN public.subscriptions.reminder_time IS 'Time of day to send the reminder';
COMMENT ON COLUMN public.subscriptions.whatsapp_number IS 'WhatsApp number to send reminders to';
COMMENT ON COLUMN public.subscriptions.last_reminder_sent IS 'Timestamp of the last reminder sent';
COMMENT ON COLUMN public.subscriptions.created_at IS 'Timestamp when the subscription was created';
COMMENT ON COLUMN public.subscriptions.updated_at IS 'Timestamp when the subscription was last updated';
...
-- ============================================
/*
-- Insert sample subscription (replace YOUR_USER_ID with actual user ID)
...
-- Test the calculate_next_payment_date function
SELECT calculate_next_payment_date('2025-01-01'::DATE, 'monthly', NULL);
*/
