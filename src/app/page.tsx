...
export default function Home() {
  return (
    <main className="min-h-screen">
      {/* Header Navigation */}
      <header className="bg-white/80 dark:bg-chocolate-900/80 backdrop-blur-md shadow-sm border-b border-gray-200 dark:border-chocolate-700 transition-colors duration-300">
